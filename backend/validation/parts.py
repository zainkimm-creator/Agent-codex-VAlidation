...
def run_part_1_parameter_validation(
    ...
    metrics = {
        ...
        "nominal_simulation_control_effort_rms_Nm": sim.metrics["control_effort_rms_Nm"],
    }
...
def _render_part_1_markdown(payload: dict[str, Any]) -> str:
    lines = [
        ...
        f"- Nominal simulation control effort RMS: `{payload['metrics']['nominal_simulation_control_effort_rms_Nm']}` N*m",
        "",
